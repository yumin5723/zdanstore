...
<head>    
	<?php 	        		
		$this->renderPartial('application.views.layouts.header1',array());       
    ?>
</head>
<body>
...
<div class="container" id="page">
	<div id="nav">
		<div class="wrap">
				<ul class="right">				
					<li><?php echo Yii::t('cms','欢迎您'); ?>, <strong><?php echo Yii::app()->user->name ?></strong>&nbsp;|&nbsp;</li>
					<li><a href="/manager/changepass"><?php echo Yii::t('cms','修改密码'); ?></a>&nbsp;|&nbsp;</li>
					<li><a href="/site/logout"><?php echo Yii::t('cms','退出'); ?></a></li>
				</ul>
