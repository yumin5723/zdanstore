...
class Game extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('name,weights,tags,source,category_id,publish_date,desc,operations_guide,how_begin,url,target,image,tag_image','required'),
            array('upload,upload1', 'file','allowEmpty'=>true),
            array('recommend_value,rank_value,recommend_image,top_image','safe'),
        );
    }
