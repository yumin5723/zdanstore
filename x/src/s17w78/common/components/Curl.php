...
class Curl extends CComponent{
    ...
    public function get($url, $params = array()){
        if(YII_DEBUG){
            Yii::log("send get request to url: ".$url." with params".print_r($params,true),CLogger::LEVEL_INFO);
        }
    ...
    public function post($url, $data = array()){
        if(YII_DEBUG){
            Yii::log("send post request to url: ".$url." with params".print_r($data,true),CLogger::LEVEL_INFO);
        }
